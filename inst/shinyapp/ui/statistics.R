        ...
        tabsetPanel(
          tabPanel(
            ...
            fluidRow(
              ...
              column(1, checkboxInput("pca_scale", "Scale", value = TRUE), class = "top25"),
              column(1, checkboxInput("pca_center", "Center", value = TRUE), class = "top25"),
          ...
          tabPanel(
            ...
            fluidRow(
              column(1, checkboxInput("use_pca", "PCA-LDA", value = TRUE), class = "top25"),

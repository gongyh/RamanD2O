...
tabItem(
  ...
  fluidRow(
    box(
      ...
      column(
        ...
        fluidRow(
          ...
          column(9, br(), p("Select the wavelength region to keep, use \"+\" and \"-\" buttons to select multiple ranges."))
        ),
    ...
    box(
      ...
      column(
        12, p("1. The wavelength region can be broader than your spectra, but should not be too narrow."),

...
tabItem(
  ...
  fluidRow(
    box(
      ...
      column(
        ...
        fluidRow(
          ...
          column(6,
                 withBusyIndicatorUI(actionButton("normalize",
                                                  "Normalize",
                                                  class = "btn-success")),
                 class = "top25")
        ),
        fluidRow(
          ...
          column(6,
                 checkboxInput("fingerprint", "Fingerprint", value = TRUE),
                 class = "top25")
        )
      )
    ),
    box(
      ...
      column(
        ...
        p("3. Check fingerprint checkbox to normalize according to
          wavelength range of 500 ~ 2000."),
  ...
  fluidRow(
    box(
      ...
      column(12,
             DTOutput("normalized_table", height = "400px") %>%
               withSpinner())
    ),
    box(

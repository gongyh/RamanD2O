...
tabItem(
    ...
    box(
      ...
      column(
        ...
        fluidRow(
          ...
          column(2, checkboxInput("filter_carotenoid",
                                  "Remove", value = TRUE), class = "top25"),
          column(4,
                 withBusyIndicatorUI(actionButton("carotenoid",
                                                  "Identification",
                                                  class = "btn-success")),
                 class = "top25")
        )
  ...
  fluidRow(
    box(
      ...
      column(12,
             DTOutput("carotenoid_table", height = "400px") %>% withSpinner())
    ),
    box(

...
tabItem(
  ...
  fluidRow(
    box(
      ...
      solidHeader = TRUE, collapsible = FALSE, width = 8,
      column(
        12,
        fluidRow(
        ...
        fluidRow(
          conditionalPanel(
            ...
            column(2,
                   withBusyIndicatorUI(actionButton("confirm_X",
                                                    "Confirm ",
                                                    class = "btn-success")),
                   class = "top25")
          ),
          conditionalPanel(
            ...
            column(4, fileInput("upload_X_file", "Ramanome dataset",
                                accept = ".csv", placeholder = "X.csv")),
            column(2,
                   withBusyIndicatorUI(actionButton("upload_X",
                                                    "Upload",
                                                    class = "btn-success")),
                   class = "top25")
          )
        ...
        fluidRow(
          column(4, fileInput("upload_Y_file", "Transcriptome dataset",
                              accept = ".csv", placeholder = "Y.csv")),
          column(2,
                 withBusyIndicatorUI(actionButton("upload_Y",
                                                  "Upload",
                                                  class = "btn-success")),
                 class = "top25")
        ),
        hr(),
        fluidRow(
          column(3, numericInput("pars_N_min1", "N_min",
                                 1, min = 1, step = 1)),
          column(3, numericInput("pars_N_max1", "N_max",
                                 5, min = 1, step = 1)),
          column(3, numericInput("pars_Nx_min1", "Nx_min",
                                 0, min = 0, step = 1)),
          column(3, numericInput("pars_Nx_max1", "Nx_max",
                                 5, min = 1, step = 1))
        ),
        fluidRow(
          column(3, numericInput("pars_Ny_min1", "Ny_min",
                                 0, min = 0, step = 1)),
          column(3, numericInput("pars_Ny_max1", "Ny_max",
                                 5, min = 1, step = 1)),
          column(3, ),
          column(3,
                 withBusyIndicatorUI(actionButton("cvadjr",
                                                  "CV_adjR2",
                                                  class = "btn-success")),
                 class = "top25")
        ),
        hr(),
        fluidRow(
          column(3, numericInput("pars_N_min2", "N_min",
                                 1, min = 1, step = 1)),
          column(3, numericInput("pars_N_max2", "N_max",
                                 5, min = 1, step = 1)),
          column(3, numericInput("pars_Nx_min2", "Nx_min",
                                 0, min = 0, step = 1)),
          column(3, numericInput("pars_Nx_max2", "Nx_max",
                                 5, min = 1, step = 1))
        ),
        fluidRow(
          column(3, numericInput("pars_Ny_min2", "Ny_min",
                                 0, min = 0, step = 1)),
          column(3, numericInput("pars_Ny_max2", "Ny_max",
                                 5, min = 1, step = 1)),
          column(3, numericInput("pars_fold", "nr_folds",
                                 6, min = 1, step = 1)),
          column(3,
                 withBusyIndicatorUI(actionButton("crossval",
                                                  "CrossVal",
                                                  class = "btn-success")),
                 class = "top25")
        ),
        ...
        fluidRow(
          ...
          column(2, numericInput("cpu_cores", "CPU cores",
                                 1, min = 1, max = 30, step = 1)),
          column(2,
                 withBusyIndicatorUI(actionButton("integrate",
                                                  "O2PLS",
                                                  class = "btn-success")),
                 class = "top25"),
          column(2,
                 withBusyIndicatorUI(actionButton("integrate2d",
                                                  "O2PLS-2D",
                                                  class = "btn-success")),
                 class = "top25")
        )

      ...
      column(
        ...
        fluidRow(
          ...
          column(2, downloadButton("download",
                 ...
                 class = "top25"),
          column(4,
                 p("Download zip file will produce an archive with
                   multiple spectrum files in txt format and
                   a metadata table file."),
                 class = "top25")
        )
      )
    )
      ...
      column(
        ...
        tabsetPanel(
          tabPanel(
            ...
            fluidRow(
              column(2, selectInput("select_ptype", "Choose type",
                choices = c("spc", "spcmeansd", "spcprctile", "spcprctl5"),
                selected = "spcprctile"
              )),
              column(2,
                     withBusyIndicatorUI(actionButton(
          ...
          tabPanel(
            ...
            fluidRow(
              column(6,
                     DTOutput("visualize_table", height = "400px") %>%
                       withSpinner()),
